...
# fname = '/fileserver/alborz/DataRelease2/sourcedata/sub-CC00553XX09/ses-159000/func/sub-CC00553XX09_ses-159000_task-rest_bold.nii.gz'
# path = '/fileserver/fetal/Arvind/fMRI/slice_to_volume_fwdmodel/DHCP/high/sub-CC00553XX09_ses-159000_task-rest_bold/bgremoved/'
...
path_to_save = '/fileserver/fetal/Arvind/fMRI/slice_to_volume_fwdmodel/DHCP/'
path_to_file = '/fileserver/fetal/Arvind/fMRI/slice_to_volume_fwdmodel/DHCP/dhcp_filenames_next.txt'
fname = open(path_to_file).read().splitlines()    
for i in range(len(fname)-1):
    ...
    f = os.path.splitext(NiftiFile)[0]
    g= os.path.splitext(f)[0]
    outFile = path_to_save + g + '/bgremoved/' + g +  '_bgremoved.nii.gz'
    maskoutbg(fmri_fname,outFile)
