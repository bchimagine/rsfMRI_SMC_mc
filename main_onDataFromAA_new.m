...
PWD = pwd;
data_path = '../datafromAA/GI_5641360_26186755/';
...
for i = 1:length(files)
    ...
    if opt.vol_start ~=1
        ...
        Y = py.pyfuncs_sv_parallelized_ss_volumelevel.numpy4Dtositk(Iorig_tr_np,origin_4d,direction_4d,spacing_4d,int32(nv));
    end
